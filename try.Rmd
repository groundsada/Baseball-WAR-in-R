...
# Load team wins data
team_wins <- read.csv("dataset/team_wins.csv")

# Transform the data from wide to long format
team_wins_long <- pivot_longer(
  team_wins,
  cols = c(ARI:WSN),  # Adjust if more teams or columns
  names_to = "Team",
  values_to = "Wins",
  values_drop_na = TRUE
)

# Include the Year in the long format
team_wins_long <- team_wins_long %>% 
